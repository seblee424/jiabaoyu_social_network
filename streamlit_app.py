        ...
        if edges_df is not None and nodes_df is not None:
            ...
            if "Phase 1" in selected_phase:
                ...
                academic_insight(
                    ...
                    "网络呈现**高密度 (High Density)** 与 **以自我为中心 (Egocentric)** 的特征。SNA数据显示，袭人、晴雯等丫鬟节点与黛玉、宝钗等小姐节点在宝玉的连接下距离几乎相等。这量化证明了宝玉“意淫”（体贴之情）的**泛爱**特征——他在试图抹平封建等级，构建一个平等的青春乌托邦。"
                )
                ...
                academic_insight(
                    ...
                    "**Modularity (模块化)** 指标可能上升，显示社群开始分化。宝玉的强连接开始向林黛玉倾斜，但薛宝钗的 **Betweenness (中介性)** 依然稳固。SNA揭示了宝玉从“泛爱”向“独钟”转变过程中的结构性张力——他的社交带宽被情感纠葛占用，导致网络边缘节点的连接开始变得脆弱。"
                )
                ...
                academic_insight(
                    ...
                    "**袭人 (Xiren)** 的 **Betweenness Centrality (中介中心性)** 在此阶段极具研究意义。她成为了连接“大观园（理想世界）”与“王夫人（现实秩序）”的**关键守门人 (Gatekeeper)**。外部高权重节点的强行插入，打断了原本自然的社交流动，SNA图谱直观展示了宝玉如何被迫接受社会规则对人际网络的切割与重组。"
                )
